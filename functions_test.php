...
if ( ! function_exists( 'LCARS_setup' ) ) {
    ...
    function LCARS_setup() {
		...
		register_nav_menus( array(
            ...
            'header_action' => esc_html__( 'Header Action', 'LCARS' ),
		) );
...
function LCARS_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'LCARS_content_width', 1170 );
}
 ...
 */
function LCARS_admin_scripts() {

}
add_action( 'admin_enqueue_scripts', 'LCARS_admin_scripts' );
...
function lcars_widgets_init()
{
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Right Header', 'lcars' ),
        'id'            => 'lcars_header',
        'description'   => esc_html__( 'Add widgets here.', 'lcars' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Left Header', 'lcars' ),
        'id'            => 'lcars_header_left',
        'description'   => esc_html__( 'Add widgets here.', 'lcars' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h2 class="widget-title">',
